...
export function AnalyzeTab() {
  ...
  return (
    <>
      <div className="w-full max-w-none px-0 mx-0 overflow-x-hidden py-6">
        <div className="pointer-events-auto">
          <div className="bg-zinc-900 rounded-xl px-6 py-10 mb-12 mx-6 shadow-lg border border-zinc-700 z-0">
